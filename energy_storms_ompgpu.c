...
int main(int argc, char *argv[]) {
    ...
    // copy maximum and positions to the gpu and create layer and layer_copy on the gpu
    
    printf("Starting, wish me luck!"); 
    ...
    */
    ...
    printf("Starting, wish me luck!");
    #pragma omp target data map(tofrom:storms[:num_storms],maximum[0:num_storms],positions[0:num_storms]) map(alloc:layer[0:layer_size],layer_copy[0:layer_size])
    {
